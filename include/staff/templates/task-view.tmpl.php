...
<div id="task_response_options" class="<?php echo $ticket ? 'ticket_task_actions' : ''; ?> sticky bar stop actions">
    <ul class="tabs">
        ...
        <li class="active"><a href="#task_reply"><i class="icon-edit icon-fixed-width"></i><?php echo __('Post Update');?></a></li>
        <li><a href="#task_note"><i class="icon-edit icon-fixed-width"></i><?php echo __('Post Internal Note');?></a></li>
        <?php
        }?>
    </ul>
    <?php
